 ...
 */
namespace Shiv\CategorySlider\Block\Category;

class CategoryList extends \Magento\Framework\View\Element\Template implements \Magento\Widget\Block\BlockInterface
{
	 /**
    ...
    public function getCategories($sorted = false, $asCollection = false, $toLoad = true)
    {
        ...
        $rootCategory = $rewriteData[1] == 63 ? 4782 : $rewriteData[1];
		$recursionLevel = 4;
