...
namespace Aheadworks\Autorelated\Block\Adminhtml\Page\Menu;
 ...
 *
 * @package Aheadworks\Autorelated\Block\Adminhtml\Page\Menu
 * @codeCoverageIgnore
 */
class Item extends \Magento\Backend\Block\Template
{
     ...
     * @var string
     */
    protected $_template = 'Aheadworks_Autorelated::page/menu/item.phtml';
    ...
    protected function _prepareLayout()
    {
        ...
        if ($this->isCurrent()) {
            /** @var \Aheadworks\Autorelated\Block\Adminhtml\Page\Menu $menu */
