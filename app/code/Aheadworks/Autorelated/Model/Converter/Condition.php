...
namespace Aheadworks\Autorelated\Model\Converter;

use Aheadworks\Autorelated\Api\Data\ConditionInterfaceFactory;
use Aheadworks\Autorelated\Api\Data\ConditionInterface;

/**
 * Class Condition
 *
 * @package Aheadworks\Autorelated\Model\Converter
 */
class Condition
{
    /**
     ...
     *
     * @param array $input
     * @return \Aheadworks\Autorelated\Api\Data\ConditionInterface
     * @SuppressWarnings(PHPMD.CyclomaticComplexity)
     */
    public function arrayToDataModel(array $input)
    {
        /** @var \Aheadworks\Autorelated\Model\Data\Condition $condition */
